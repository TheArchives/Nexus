        ...
        while self.buffer:
            ...
            if type == TYPE_INITIAL:
                ...
                if self.factory.irc_relay:
                    self.factory.irc_relay.sendServerMessage("\x033[+] %s%s \x0307has come online." % (self.userColour(), self.username))
                ...
                message = message.replace("\x030", "&f")       #TODO Fish - Aren't these color codes already taken care of by the irc bot's code?
                message = message.replace("\x0300", "&f")
                message = message.replace("\x031", "&0")
                message = message.replace("\x0301", "&0")
                message = message.replace("\x032", "&1")
                message = message.replace("\x0302", "&1")
                message = message.replace("\x033", "&2")
                message = message.replace("\x0303", "&2")
                message = message.replace("\x034", "&c")
                message = message.replace("\x0304", "&c")
                message = message.replace("\x035", "&4")
                message = message.replace("\x0305", "&4")
                message = message.replace("\x036", "&5")
                message = message.replace("\x0306", "&5")
                message = message.replace("\x037", "&6")
                message = message.replace("\x0307", "&6")
                message = message.replace("\x038", "&e")
                message = message.replace("\x0308", "&e")
                message = message.replace("\x039", "&a")
                message = message.replace("\x0309", "&a")
                message = message.replace("\x0310", "&3")
                message = message.replace("\x0311", "&b")
                message = message.replace("\x0312", "&9")
                message = message.replace("\x0313", "&d")
                message = message.replace("\x0314", "&8")
                message = message.replace("\x0315", "&7")
